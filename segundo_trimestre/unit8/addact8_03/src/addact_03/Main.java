...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Si " + cocodrilo.getNombre() + " crece "
                + tamanyo + " m, pasará a medir " + cocodrilo.getAltura() 
                + " m.");
        System.out.println("Si " + cocodrilo.getNombre() + " envejece "
                + anyos + " años, pasará a tener " + cocodrilo.getEdad() 
                + " años.");
        ...
        // test clase Lagarto
        System.out.println("\nVamos a probar la clase Lagarto: ");
        Lagarto komodo = new Lagarto("Dragón de komodo", 2.6, 
                79,20, 25, "macho");
        System.out.println(komodo.toString());
        System.out.println(komodo.mudarPiel());
        System.out.println(komodo.ponerHuevo());
        System.out.println(komodo.sisear());
